...
@section('title') {{ trans('admin.sales') }} @endsection
    ...
    <section>
        <div class="card">
            <div class="card-header">
                <div class="tbl-title">{{ trans('admin.sales') }}</div>
            </div>
            <hr>
            <div class="card-content">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="sales-table" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    ...
                                    <th>
                                        @if(auth()->user()->can(['update_sales', 'delete_sales']))
                                        {{ trans('admin.action') }}
                                        @endif
                                    </th>
                                </tr>
        ...
        $('#sales-table').DataTable({
            ...
            buttons: [
                ...
                { text: '<i class="feather icon-plus"></i> {{ trans("admin.create_role") }}',
                  className: '@if (auth()->user()->can("create_sales")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                  attr: {
