...
@section('title') {{ trans('admin.manufacturers') }} @endsection
    ...
    <section>
        <div class="card">
            <div class="card-header">
                <div class="tbl-title">{{ trans('admin.manufacturers') }}</div>
            </div>
            <hr>
            <div class="card-content">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="manufacturers-table" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
            ...
            buttons: [
                ...
                { text: '<i class="feather icon-plus"></i> {{ trans("admin.create_manufacturer") }}',
                  ...
                  attr: {
                    ...
                    {
                        // href location
                        window.location.href = '{{ route("admin.manufacturers.create") }}';
                    }
                },
            ],
            language: {
