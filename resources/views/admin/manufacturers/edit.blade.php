...
@section('title') {{ trans('admin.edit_manufacturer') }} @endsection
...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ trans('admin.edit_manufacturer') }}</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ trans('admin.edit_manufacturer') }}</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            ...
                            {{ trans('admin.edit_manufacturer') }} - {{ $manufacturer->name }}
                        </h4>
                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input id="name" type="text" name="name[{{ $locale }}]"
                                                    class="form-control"
                                                    value="{{ old('name.' . $locale, $manufacturer->getTranslation('name', $locale)) }}"
