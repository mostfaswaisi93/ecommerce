...
@section('title') {{ trans('admin.trade_marks') }} @endsection
    ...
    <section>
        <div class="card">
            <div class="card-header">
                <div class="tbl-title">{{ trans('admin.trade_marks') }}</div>
            </div>
            <hr>
            <div class="card-content">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="trade_marks-table" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
            ...
            buttons: [
                ...
                { text: '<i class="feather icon-plus"></i> {{ trans("admin.create_trade_mark") }}',
                  ...
                  attr: {
                    ...
                    {
                        // href location
                        window.location.href = '{{ route("admin.trade_marks.create") }}';
                    }
                },
            ],
            language: {
