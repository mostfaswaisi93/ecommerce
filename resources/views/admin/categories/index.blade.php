    ...
    <section>
        <div class="card">
            <div class="card-header">
                <div class="tbl-title">{{ trans('admin.categories') }}</div>
            </div>
            <hr>
            <div class="card-content">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="categories-table" class="table table-striped table-bordered dt-responsive nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
    ...
    $(document).ready(function(){
        $('#categories-table').DataTable({
            ...
            buttons: [
                ...
                { text: '<i class="feather icon-plus"></i> {{ trans("admin.create_category") }}',
