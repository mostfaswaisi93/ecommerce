    ...
    <section>
        <div class="card">
            <div class="card-header">
                <div class="tbl-title">{{ trans('admin.products') }}</div>
            </div>
            <hr>
    ...
    $(document).ready(function(){
        ...
        $('#data-table').DataTable({
            ...
            buttons: [
                ...
                { text: '<i class="feather icon-plus"></i> {{ trans("admin.create_product") }}',
                  className: '@if (auth()->user()->can("create_products")) btn dtbtn btn-sm btn-primary @else btn dtbtn btn-sm btn-primary disabled @endif',
                  attr: {
